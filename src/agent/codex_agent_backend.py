...
_BASE_INSTRUCTIONS = (
    "You are the SEA stock-analysis Agent runtime. SEA instructions and SEA tools define your task; "
...
_NO_STOCK_SCOPE_INSTRUCTION = (
    "No stock scope was established for this turn. Do not call any SEA tool that requires a "
...
_PUBLIC_ERROR_MESSAGES = {
    "command_not_found": "运行 SEA 的设备找不到 Codex，请前往 Agent 设置检查安装和 PATH。",
    "login_required": "Codex 尚未登录，请在运行 SEA 的设备上完成登录后重试。",
    ...
    "resource_cleanup_failed": "Codex Agent 未能安全结束本次后台任务，请重启 SEA 服务后再试。",
...
class CodexAgentBackend(AgentBackend):
    """Execute one SEA Chat turn in a new ephemeral Codex App Server."""
            ...
            with self.transport_factory(
                ...
                if not tool_names:
                    raise CodexAppServerError(
                        ...
                        "No cancellation-safe SEA tools are available to Codex",
                    )
