...
def screen(
    ...
    *,
    ...
    Args:
        ...
        deep_analysis_max_picks: Backward-compatible max-picks alias for SEA.
        ...
        context: Optional host runtime context. SEA may provide LLM settings and
    ...
    # 6.5. Host-provided candidate context, e.g. SEA realtime quote,
    ...
    # 11. Optional L3 post-analysis, SEA is only one possible analyzer.
    if analyzer_names:
