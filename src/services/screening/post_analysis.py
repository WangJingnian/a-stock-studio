...
SEA is one analyzer backend. The pipeline can also use local scorecards or an
external HTTP scoring tool without making SEA part of the core selection path.
"""
...
def run_post_analyzers(
    ...
    *,
    ...
    that may enter bounded near-score rotation without expanding remote SEA or
    external HTTP work.
    """
