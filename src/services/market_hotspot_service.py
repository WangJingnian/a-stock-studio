# -*- coding: utf-8 -*-
"""SEA-native market hotspot context service.

This service intentionally does not import AlphaSift.  It builds the first
market-theme layer from SEA's existing industry/concept ranking providers and
...
class MarketHotspotService:
    """Build low-sensitive A-share market/theme context from SEA rankings."""
